...
const SPACE_TEXT = "----------------------------------"
const LOGIN_FALSE_TEXT = "Sorry we couldnt find the same user, try sm else"
const LOGIN_TRUE_TEXT = "Nice! We could find the user!"
const USERS_BASE_EMPTY_TEXT = "Sorry, but we havent any users now"